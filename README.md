...
```python
class SiyabongaMlambo:

    def __init__(self):
        self.name         = "Siyabonga Mlambo"
        self.alias        = "Sya"
        self.location     = "Kimberley, Northern Cape, South Africa 🇿🇦"
        self.role         = "Data Scientist | Quantitative Risk Analyst | XAI Researcher"
        self.education    = "MSc Computer & Information Science — Data Science"
        self.university   = "Sol Plaatje University 🎓"
        self.status       = "Master's Candidate · Thesis in progress"

    def current_focus(self):
        return {
            "thesis"      : "Explainability in ML models for financial credit risk assessment",
            "tools"       : ["SHAP", "XGBoost", "LightGBM", "Python"],
            "question"    : "Can we make AI decisions in finance transparent AND accurate?",
        }

    def tech_stack(self):
        return {
            "languages"   : ["Python 🐍", "SQL", "R"],
            "ml"          : ["Scikit-learn", "XGBoost", "LightGBM", "SHAP", "Prophet"],
            "analytics"   : ["Power BI", "Excel", "Streamlit", "Plotly", "Pandas"],
            "databases"   : ["PostgreSQL", "MySQL"],
            "tools"       : ["Git", "Jupyter", "VS Code", "Google Cloud"],
        }

    def interests(self):
        return [
            "🔍 Explainable AI & model interpretability",
            "🏦 Credit risk modelling & quantitative finance",
            "📊 Data visualization & analytics dashboards",
            "🤖 Machine learning engineering",
            "🧪 Statistical modelling & research",
            "💡 Anything that turns raw data into real decisions",
        ]
    ...
    def open_to(self):
        return [
            ...
            "Freelance analytics & ML projects",
...
me = SiyabongaMlambo()
print(me)
# >>> Building AI that explains itself, one SHAP value at a time. 🚀
```
...
- Customer churn detection (deployed Streamlit app)
...
- Power BI risk dashboards (24+ KPIs)
- Excel financial modelling & KPI reporting
- SQL customer segmentation pipelines
- Interactive Streamlit analytics apps
...
### 🔬 Research
- MSc thesis: XAI in financial credit risk
- SHAP vs LIME comparative analysis
- Interpretable ML for regulated industries
- Fairness & bias in credit scoring

</td>
<td width="50%">

### 🛠️ Engineering
- End-to-end ML pipelines (data → deploy)
- RAG-powered AI assistants
- dbt data transformation pipelines
- Automated reporting & alerting systems
...
<img height="180em" src="https://github-readme-stats.vercel.app/api?username=syamlambo&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true&border_color=7c6ff7&bg_color=0d0d1a&title_color=7c6ff7&text_color=9898b0&icon_color=2dd4a8&hide_border=false"/>
&nbsp;
<img height="180em" src="https://github-readme-stats.vercel.app/api/top-langs/?username=syamlambo&layout=compact&langs_count=8&theme=tokyonight&border_color=7c6ff7&bg_color=0d0d1a&title_color=7c6ff7&text_color=9898b0&hide_border=false"/>
...
- 🏦 [How I Built a Credit Risk Model with SHAP Explainability](https://yourblog.com)
- 🔍 [Explainable AI in Finance: Why Black Boxes Break Trust](https://yourblog.com)
- 📊 [Power BI for Risk Analysts: Beyond Basic Bar Charts](https://yourblog.com)
- 🐍 [5 Pandas Patterns Every Data Scientist Should Know](https://yourblog.com)
...
<a href="https://linkedin.com/in/syamlambo">
